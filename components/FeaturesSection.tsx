          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-12 flex justify-center">
              <button 
                ...
                className="group flex items-center gap-3 px-8 py-4 rounded-full border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900 text-slate-800 dark:text-white font-bold text-sm uppercase tracking-widest transition-all duration-300 hover:border-blue-500 dark:hover:border-blue-400 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-1 active:scale-95"
              >
                <BoltIcon className="w-4 h-4 text-blue-600 dark:text-blue-400 group-hover:fill-current transition-all" />
