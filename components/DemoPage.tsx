          ...
          <div className="lg:col-span-7">
            <div className="demo-form-container relative">
              ...
              <div className="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-3xl shadow-2xl p-8 md:p-12 overflow-hidden">
                {!formSubmitted ? (
                  <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400 font-space">Primary Interest</label>
                      <select className="w-full px-5 py-4 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all appearance-none cursor-pointer">
                        <option>ERP & Student Life-Cycle</option>
                        <option>Hybrid Classroom Technology</option>
                        <option>NAAC / NIRF Compliance Reporting</option>
                        <option>Financial & Fee Management</option>
              ...
              <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 space-y-4 shadow-sm group cursor-pointer hover:-translate-y-2 transition-all">
                    <div className="w-8 h-8 rounded-lg bg-orange-100 dark:bg-orange-950/50 flex items-center justify-center text-orange-600 dark:text-orange-400 group-hover:rotate-12 transition-transform">
                      <ChartBarSquareIcon className="w-5 h-5" />
                    </div>
                    <h4 className="font-black font-space tracking-tight text-slate-900 dark:text-white">Download Brochure</h4>
                    <p className="text-sm text-slate-500 dark:text-slate-400 font-light leading-relaxed">PDF overview of all technical specifications.</p>
                    <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest pt-2 text-blue-600 dark:text-blue-400">
