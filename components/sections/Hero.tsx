    ...
    <section ref={containerRef} className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-4 bg-slate-50 dark:bg-slate-950 transition-colors duration-500 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center space-y-10 relative z-10">
          <div className="hero-badge inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-50 dark:bg-orange-950 border border-orange-100 dark:border-orange-900/50 text-orange-700 dark:text-orange-400 text-[10px] font-black uppercase tracking-[0.2em] font-space">
            <GlobeAltIcon className="w-3.5 h-3.5 text-orange-600 dark:text-orange-500 animate-[spin_8s_linear_infinite]" />
            {t('hero.badge')}
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 pt-6">
            ...
            <button 
              onClick={() => onNavigate?.('demo')}
              className="hero-btn w-full sm:w-auto px-10 py-5 bg-orange-50 dark:bg-orange-900/10 text-orange-700 dark:text-orange-400 border border-orange-200 dark:border-orange-800/30 rounded-2xl font-bold text-lg hover:bg-orange-100 dark:hover:bg-orange-900/20 transition-all flex items-center justify-center gap-3 shadow-lg active:scale-95"
            >
