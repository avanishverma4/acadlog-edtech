          ...
          {tiers.map((tier, idx) => (
            <div 
              ...
              className={`relative p-8 rounded-2xl border transition-all duration-300 ${
                ...
                : 'bg-white/50 dark:bg-slate-950/50 border-slate-200 dark:border-white/10 hover:border-slate-300 dark:hover:border-white/20'
              }`}
            >
              {tier.featured && (
              ...
              <button 
                ...
                : 'bg-white dark:bg-white/5 text-slate-900 dark:text-white border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/10'
              }`}>
                {tier.cta}
              </button>
            </div>
